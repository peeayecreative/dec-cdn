...
// }
    ...
    events: {
      ...
      url: myAjax.ajaxurl + "?action=fetch_Events&locale=" + language + "&dateformat=" + myAjax.date_format + "&timeformat=" + myAjax.time_format + "&timezone=" + myAjax.show_time_zone+ "&show_time_zone_on_calendar=" + myAjax.show_time_zone_on_calendar +"&timezone_abb=" + myAjax.show_time_zone_abb + "&venue=" + myAjax.show_venue + "&location=" + myAjax.show_location + "&street=" + myAjax.show_address + "&locality=" + myAjax.show_locality + "&postal=" + myAjax.show_postal +
