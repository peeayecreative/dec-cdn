...
//   // Check if both start and end times are null, undefined, or empty
...
if (myAjax.show_time_zone_on_calendar == 'on') {
  ...
  if (myAjax.show_event_venue == "on" && info.event.extendedProps.show_event_venue) {
      eventHtml += '<div class="fc-calendar-venue">' + info.event.extendedProps.show_event_venue + '</div>';
  }
...
// }
    ...
    events: {
      ...
      url: myAjax.ajaxurl + "?action=fetch_Events&locale=" + language + "&dateformat=" + myAjax.date_format + "&timeformat=" + myAjax.time_format + "&timezone=" + myAjax.show_time_zone+ "&show_time_zone_on_calendar=" + myAjax.show_time_zone_on_calendar+ "&show_event_venue=" + myAjax.show_event_venue +"&timezone_abb=" + myAjax.show_time_zone_abb + "&venue=" + myAjax.show_venue + "&location=" + myAjax.show_location + "&street=" + myAjax.show_address + "&locality=" + myAjax.show_locality + "&postal=" + myAjax.show_postal +
